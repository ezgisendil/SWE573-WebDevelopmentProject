    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_posted', models.DateTimeField(default=django.utils.timezone.now)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='service.event')),
                ('offer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='service.offer')),
